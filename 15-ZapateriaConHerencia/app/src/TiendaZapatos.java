...
public class TiendaZapatos {
    ...
    static Casual casual2 = new Casual("Tommy", "Casual", "tela", 150F, false);
            ...
            if (!option.equals("4")) {
                switch (option) {
                    case "1":
                        ...
                        System.out.println("Zapato creado correctamente");
    ...
    public static Casual crearCasual() {
        ...
        Float precio = teclado.nextFloat();
        teclado.nextLine();
        System.out.println("El zapato Casual tiene correa?");
