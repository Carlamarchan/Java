...
public class Papeleria extends Tienda implements SorteoCliente {

    public Papeleria(String nombreTienda, String direccion) {
        super(nombreTienda, direccion);
    }

    @Override
    public void inscribirDatosCliente(Scanner teclado) {
        System.out.println("Bienvenido a tu Papelería " + this.getNombreTienda());
